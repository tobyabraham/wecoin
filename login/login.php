...
if(!empty($_POST['email'])) {
    ...
    if(mysqli_num_rows($rs)>0){
       ...
       if($newvalue=='admin@wecoin.com'){
        session_start(); 
        $_SESSION["admin"]=$newvalue;
        header("Location: ../user/spot"); 
       } 
       else{
        date_default_timezone_set("Africa/Lagos");
        $curTime = date("Y-m-d h:i:sa");
           $query = "UPDATE `users` SET `last login`= '$curTime' WHERE `email`='$email'";
           mysqli_query($conn,$query) or die("Could Not Perform the Query");
        session_start(); 
        $_SESSION["user"]=$newvalue;
...
<head>
    ...
    <title data-shuvi-head="true">Log In | WeCoin Trade</title>
...
body {
    ...
    width: 100%;
    height: 40px;}
        .css-hiy16i{box-sizing: border-box;
margin: 0px;
min-width: 0px;
width: 100%;
position: relative;
...
<body>
    ...
    <div id="__APP">
        <div class="css-1s6w302"><a href="https://www.Wecoin Trade.com/en"><img
                    src="https://bin.bnbstatic.com/static/images/common/nav-logo.svg" alt="Wecoin Trade"></a>
        ...
        <div class="css-1i3ha4y">
            <div class="css-13eeyma"><a href="../"><img
                        src="../logo.png" alt="WeCoinTrade" ></a>
                <div class="css-x84wzl">
                    <div class="css-ybbx55">
                        <div class="css-11yl1bg"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                class="css-1iztezc">
                ...
                <div class="css-moj0yw">
                    <div class="css-yqufh">
                        <div data-bn-type="text" class="css-leflpn">
                            <div data-bn-type="text" class="css-tb94u7">Log In</div>
                            <div data-bn-type="text" class="css-ft5043">Please check that you are visiting the correct
                                URL</div>
                               
                              <h4>Incorrect Email/Password. Try Again</h4>;
                        ...
                        <div class="css-vurnku">
                            ...
                            <div class="css-gnqbje">
                                <form action="#" method="post" autocomplete="off">
                                        ...
                                        <div class="css-15651n7">
                                            ...
                                            <div class=" css-hiy16i">
                                                <div class=" css-azvb1b"><input data-bn-type="input"
                                                        ...
                                                        type="password" class="css-uesmnb" value="">
                                                    <div class="bn-input-suffix css-vurnku">
                                                        <div class="css-1gkkq18"></div>
                                                    </div>
                                                </div>
                                    ...
                                    </div><button data-bn-type="button" id="click-registration-submit" type="flatprimary" class="css-ur4fg7">Log In</button>
                                </form>
                            </div>
                        ...
                        <div class="css-1xks0kt">
                            ...
                            <div class="css-1uwb95w"><a data-bn-type="link" class="css-1d4gjwi"
                                    href="../register/">Create Account</a></div>
                        </div>
                    </div>
                </div>
            </main>
