                                        ...
                                        <br />
                                                ...
                                                <div class=" css-3ntzf7">
                                                    <div class="bn-input-prefix css-vurnku"><label data-bn-type="text"
                                                        ...
                                                        type="number" min="0.001" step="0.001" value="" requied="required">
                                                    <div class="bn-input-suffix css-vurnku"><label data-bn-type="text"
                                                            for="FormRow-normal-quantity"
                                                            style="display: inline-block; text-align: right;"
    ...
    <script>
       ...
       //orderbook.append(messageObj.p);
        ...
        function orderBook() {
            ...
            ourRequest.open('GET', 'https://api.binance.com/api/v1/depth?symbol=XRPUSDT&limit=5', true);
        ...
        function getBitPric(){
            ...
            document.getElementById("buybals").value = parseFloat(document.getElementById("buyamounts").value*(bitcoinData[2]["rate"]/bitcoinData[15]["rate"])).toFixed(2);
            }
            bitPric.send();
        }
        getBitPrice();
        ...
        function getUsdPrice(){
           ...
           document.getElementById("sellbal").value = (bitcoinData[2]["rate"]/bitcoinData[15]["rate"]);
