            ...
            <div class="col-md-3">
               ...
               <div class="col-md-12">
                <div class="row" style="background: rgb(20, 21, 26) !important;color:rgb(20, 21, 26);font-size: 8px;">
                    ...
                    <div class="col-md-3" >
                        <button style="font-size: 10px;" type="button"  onclick="window.location.href='ETH_USDT.php'" class="btn btn-outline-dark">ETH/ISDT</button>
                    </div>
                    <div class="col-md-3" >
                                    ...
                                    <div  class="css-454r4r">
                                        <div  class=" css-3ntzf7">
                                            <div class="bn-input-prefix css-vurnku"><label data-bn-type="text"
                                                ...
                                                id="buybal" name="buyprice" class=" css-1wlt96c"
                                        ...
                                        <br />
                                                ...
                                                <div class=" css-3ntzf7">
                                                    <div class="bn-input-prefix css-vurnku"><label data-bn-type="text"
                                                        ...
                                                        type="text" min="0.001" step="0.001" value="" required="required">
                                                    <div class="bn-input-suffix css-vurnku"><label data-bn-type="text"
                                                            for="FormRow-normal-quantity"
                                                            style="display: inline-block; text-align: right;"
    ...
    <script>
       ...
       //orderbook.append(messageObj.p);
        ...
        function orderBook() {
            ...
            ourRequest.open('GET', 'https://api.binance.com/api/v1/depth?symbol=BTCUSDT&limit=5', true);
        ...
        function getBitPric(){
            ...
            document.getElementById("buybals").value = parseFloat(document.getElementById("buyamounts").value*(bitcoinData[2]["rate"])).toFixed(2);
            }
            bitPric.send();
        }
        getBitPrice();
        function getBitPrice(){
            ...
            var bitp = parseFloat(document.getElementById("buyamount").value*(bitcoinData[2]["rate"])).toFixed(2);
            document.getElementById("buybal").value = parseFloat(bitcoinData[2]["rate"]).toFixed(2);
        ...
        function getUsdPrice(){
           ...
           document.getElementById("sellbal").value = (bitcoinData[2]["rate"]);
