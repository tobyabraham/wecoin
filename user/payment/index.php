...
if(isset($_SESSION["user"])){
    if(isset($_POST['coin'])){
    if($_POST['bitc'] > $_SESSION['mainbalance']){
...
if($_POST['bitc'] < $_SESSION['mainbalance']){
    ...
    VALUES ('$email','$trid','$curdate','$amount','$paymode','$stat','D')";
                            ...
                            <div class="css-55pfc8">
                                ...
                                <div class="css-17utxv0">
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a data-toggle="tab" href="#bitpay">Bitcoin</a></li>
                                        <li><a data-toggle="tab" href="#litepay">Litecoin</a></li>
                                        <li><a data-toggle="tab" href="#ethpay">Ethereum</a></li>
                                        
                                      </ul>
                                    
                                      <div class="tab-content">
                                        <div id="bitpay" class="tab-pane fade in active">
                                          <h3>Bitcoin</h3>
                                          <form method="post" action="" style="display:inline;">
                                            <input name="bitc" type="number" placeholder="Enter Amount">
                                            <button name="coin" value="BTC" style="background-color:turquoise;">Proceed to make BTC payment</button>
                                        <img src="pay.png" style="width:200;height:200px;">  
                                        </form>
                                        </div>
                                        <div id="litepay" class="tab-pane fade">
                                          <h3>Litecoin</h3>
                                          <form method="post" action="" style="display:inline;">
                                            <input name="bitc" type="number" placeholder="Enter Amount">
                                            <button name="coin" value="LTC" style="background-color:turquoise;">Proceed to make LiteCoin payment</button>
                                            <img src="pay.png" style="width:200;height:200px;">   
                                        </form>
                                        </div>
                                        <div id="ethpay" class="tab-pane fade">
                                          <h3>Ethereum</h3>
                                          <form method="post" action="" style="display:inline;">
                                            <input name="bitc" type="number" placeholder="Enter Amount">
                                            <button name="coin" value="ETH" style="background-color:turquoise;">Proceed to make ETH payment</button>
                                            <img src="pay.png" style="width:200;height:200px;">   
                                        </form>
                                        </div>
                                      ...
                                      echo "<table  style='text-align:left;'class='table' style='font-size:14px !important;padding-bottom:10px;'>
                                            ...
                                            $querys = "SELECT * FROM `payments` WHERE `WorD` = 'D' "; //You don't need a ; like you do in SQL
