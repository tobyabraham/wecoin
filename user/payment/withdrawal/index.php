...
if(isset($_SESSION["user"])){
    ...
    if($_POST['walletamount'] > $_SESSION['mainbalance']){
...
if($_POST['walletamount'] < $_SESSION['mainbalance']){
    ...
    $crypt = $_POST['wallettype'];
    $walletid = $_POST['walletaddress'];
    $amount = $_POST['walletamount'];
    $curdate = date("Y-M-d, h:i:sa");
    $querywd = "INSERT INTO `payments`(`email`, `Transaction ID`, `Date`, `Amount`, `Payment Mode`, `Status`,`WorD`) 
    VALUES ('$email','$trid','$curdate','$amount','$crypt','$stat','W')";
    mysqli_query($conn,$querywd) or die("Could Not Perform the Query");
}
    }
?>
...
element {
    ...
    transform: translate(1058px, 257px);
}
.css-gv1gi9 {
    box-sizing: border-box;
    margin: 0px;
...
.css-p8owu0 {
    ...
    <title>Payments - WeCoin Trade</title>
</head>
...
<body dir="ltr" style="overflow: auto; position: static;"><svg aria-hidden="true"
  ...
  <a data-bn-type="link" href="/user/tps" class="css-6ijtmk">
                    ...
                    <div class="css-16vu25q">
                        <div class="css-1d4x75a">
                            <div class="css-55pfc8">
                                <div class="css-p8owu0">
                                    <h1 data-bn-type="text" class="css-1h380np">Payment</h1>
                                </div>
                                <div class="css-17utxv0">
                                    <div class="css-mca8vp">
                                       ...
                                       <a href="/user/payment/"> <div id="tab-crypto" class="css-ov54vn">
                                            <div class="css-1dywarg">
                                                <div data-bn-type="text" class="css-5slpb6">Deposit</div>
                                            </div></a>
                                        </div>
                                        <a href="/user/payment/withdrawal">     <div id="tab-withdraw" class="css-ov54vn">
                                            <div class="css-oxzfpw">
                                                <div data-bn-type="text" class="css-1ms5o0x">Withdraw</div>
                                            </div>
                                        </div></a>
                                    </div>
                                    <div class="css-778ayn">
                                      
                                                
                                                <div class="css-1rttasy">
                                                   <div  style="display:inline; margin-left: 10px;">
                                                       <form method="post" action="">
                                                        <select class="paymentstyle" style="transition-duration:0.4s; color:black; border-radius: 12px !important; border:2px solid #bd6f05;"  id="wallet" name="wallettype" value="select" required>
                                                            <option value="" selected disabled hidden>Wallet Type</option>
                                                            <option value="bitcoin" id="btc" name="bitcoin">Bitcoin</option>
                                                            <option value="litecoin" id="ltc" name="litecoin">Litecoin</option>
                                                            <option value="ethereum" id="eth" name="ethereum">Ethereum</option>
                                                        </select>
                                                        <input class="paymentstyle" style="padding: 15px 150px !important;" type="text" placeholder="Wallet Address" name="walletaddress" required="required">
                                                        <input class="paymentstyle" style="padding: 15px 20px !important;" type="number" placeholder="Amount" name="walletamount" required="required">
                                                        <input name= "withdraw" class="paymentstyle" style="transition-duration:0.4s; color: black; border-radius: 12px !important; border:2px solid #bd6f05;" type="submit" value="Withdraw">
                                                       </form>
                                                   </div>
                                    ...
                                    <?php  
                                    echo "<table  style='text-align:left;'class='table' style='font-size:14px !important;padding-bottom:10px;'>
                                          ...
                                          $querys = "SELECT * FROM `payments` WHERE `WorD` = 'W' "; //You don't need a ; like you do in SQL
                                          ...
                                          echo" <th>" .$tid."</th> 
                                                ...
                                                while($row = mysqli_fetch_array($results)){
                                                    $rows = $rows +1;
                                                    echo "<br/><tr style='color:Black;'><td>".$row['Transaction ID']. "</td>
                                                    <td>" .$row['Date']."</td>
