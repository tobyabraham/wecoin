...
.css-gqubw1 {
    ...
    line-height: 20px;
    border-bottom: 1px dotted rgb(71, 77, 87);
...
.css-1u9esp9, .css-1u9esp9::before {
...
.css-1yof1af {
    ...
    <title>Referrals - WeCoin Trade</title>
</head>
...
<body dir="ltr" style="overflow: auto; position: static;"><svg aria-hidden="true"
  ...
  <a data-bn-type="link" href="/wecoin/user/tps" class="css-6ijtmk">
                    ...
                    <div class="css-1f90xqf">
                    <div class="css-vsmjo9">
                        <div class="css-nypevf">
                            <div class="css-4cffwv">
                                <div data-bn-type="text" class="css-gqubw1">You Earned</div>
                                <div class="bn-tooltip-box css-1yof1af"
                                    style="position: absolute; left: -74px; top: -40px; transition: opacity 120ms ease-in-out 0s, transform 120ms ease-in-out 0s; opacity: 0; transform: translate3d(0px, -6px, 0px); visibility: hidden;"
                                    data-popper-reference-hidden="false" data-popper-escaped="false"
                                    data-popper-placement="top">The total commission estimate is converted into BTC at
                                    the exchange rate of yesterday’s closing price and the value is for reference only.
                                    <div class="bn-tooltip-arrow css-1u9esp9" data-popper-arrow="true"
                                        style="position: absolute; left: 139px;"></div><i class="gap-fill"></i></div>
                            </div>
                            <div class="css-enhan1">
                                <div data-bn-type="text" class="css-rcthv6">0</div>
                            </div>
                        </div>
                        <div class="css-nypevf">
                            <div class="css-4cffwv">
                                <div data-bn-type="text" class="css-gqubw1">Total Number of Traded Friends</div>
                                <div class="bn-tooltip-box css-1yof1af"
                                    style="position: absolute; left: 350px; top: -104px; transition: opacity 120ms ease-in-out 0s, transform 120ms ease-in-out 0s; opacity: 0; transform: translate3d(0px, -6px, 0px); visibility: hidden;"
                                    data-popper-reference-hidden="false" data-popper-escaped="false"
                                    data-popper-placement="top">The total number of single-account registration friends.
                                    A friend invited and registered on Binance, including multiple accounts of the same
                                    user, is marked as 1 friend. A green mark next to the "Total Number of Traded
                                    Friends" under the "All Time" range indicates the number of friends’ first trade
                                    completed yesterday.<div class="bn-tooltip-arrow css-1u9esp9"
                                        data-popper-arrow="true" style="position: absolute; left: 157px;"></div><i
                                        class="gap-fill"></i></div>
                            </div>
                            <div class="css-enhan1">
                                <div data-bn-type="text" class="css-rcthv6">0</div>
                            </div>
                        ...
                        <div class="css-nypevf">
                            <div class="css-4cffwv">
                                <div data-bn-type="text" class="css-gqubw1">Total Numbers of Friends</div>
                                <div class="bn-tooltip-box css-1yof1af"
                                    style="position: absolute; left: 708px; top: -72px; transition: opacity 120ms ease-in-out 0s, transform 120ms ease-in-out 0s; opacity: 0; transform: translate3d(0px, -6px, 0px); visibility: hidden;"
                                    data-popper-reference-hidden="false" data-popper-escaped="false"
                                    data-popper-placement="top">The total number of friends who have been deduplicated.
                                    Once the invitation is completed and friend is registered with Binance, including
                                    multiple accounts of the same user, they will be counted as 1 friend.<div
                                        class="bn-tooltip-arrow css-1u9esp9" data-popper-arrow="true"
                                        style="position: absolute; left: 157px;"></div><i class="gap-fill"></i></div>
                            </div>
                            <div class="css-enhan1">
                                <div data-bn-type="text" class="css-rcthv6">0</div>
                            </div>
                        </div>
                        <div class="css-jf7lwt">
                            <div class="css-4cffwv">
                                <div data-bn-type="text" class="css-oiafs6">Your Ranking</div>
                                <div data-bn-type="text" class="css-59uzei">Ranking List &gt;</div>
                            </div>
                            <div data-bn-type="text" class="css-rcthv6">--</div>
                        </div><img src="/wecoin/img/bonus.png"
                            class="css-1u4romx">
                    </div></div>
                </main>
            </main>
