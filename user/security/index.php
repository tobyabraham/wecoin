...
if(isset($_SESSION['user'])){
    ...
    if(isset($_POST['pin'])){
        $pinval = $_POST['pin'];
        $query = "UPDATE `users` SET `pin`= '$pinval' WHERE `email`='$email'";
        mysqli_query($conn,$query) or die("Could Not Perform the Query");

    }
    if(isset($_POST['password'])){
        $passval = $_POST['password'];
        $querys = "UPDATE `users` SET `password`= '$passval' WHERE `email`='$email'"; 
        mysqli_query($conn,$querys) or die("Could Not Perform the Query");
...
.css-15nm7oo {
    ...
    <title>Security - WeCoin Trade</title>
</head>
...
<body dir="ltr" style="overflow: auto; position: static;"><svg aria-hidden="true"
            ...
            <main class="css-1wr4jig">
                <main class="css-xry4yv">
                    ...
                    <div class="css-3miali"><a data-bn-type="link" class="css-6ijtmk" href="/wecoin/user/">
                        ...
                        </a><a data-bn-type="link" href="/wecoin/user/security" class="css-z87e9z">
                            <div class="css-10j588g"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
  ...
  <a data-bn-type="link" href="/wecoin/user/tps" class="css-6ijtmk">
                    ...
                    <div class="css-1wr4jig">
                        <div class="css-u8gr5">
                            <div class="css-fhl5lc"><a data-bn-type="link" class="css-130o28w"
                                    href="/en/my/security">Security</a><svg xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 16 16" fill="none" class="mirror css-1vzthy9">
                                    <path d="M8.825 8L3.95 12.95 5 14l6-6-6-6-1.05 1.05L8.825 8z" fill="currentColor">
                                    </path>
                                </svg></div>
                        </div>
                        <div class="css-1f90xqf">
                            <div class="css-fd2mzq">
                                <div data-bn-type="text" class="css-1wi8tvl">INCREASE YOUR ACCOUNT SECURITY </div>
                             
                            </div>
                            <div class="css-135q3b7">
                                <div class="css-1rdpbaa">
                                
                                    <div class="css-1ma4ge9">
                                        <div class="css-vhzuyw">
                                            <div data-bn-type="text" class="css-etx2pa">Add PIN </div>
                                            <div id="buysell" class="css-1228rfh">
                                            </div>
                                        </div>
                                        <div class="css-1xeouxk" >
                                            <div class="row">
                                                <div class="col-md-12">
                                                        ...
                                                        <div  class="row" >
                                                            ...
                                                            <div id="pin" class="tab-pane" >
                                                                    ...
                                                                    <div class="row" >
                                                                        ...
                                                                        <div class="bn-input-md css-1ej5pym"><input type="number" data-bn-type="input" value=""
                                                                 name="pin"    id="pins" placeholder="New Pin" class="css-16fg16t">
                                                                            <label class="bn-input-label css-6lqe90"></label>
                                                                        </div>
                                                                       <div class="css-15nm7oo"></div>
                                                                       <div class="bn-input-md css-1ej5pym"><input type="number" data-bn-type="input" value=""
                                                                name="confirm_pin" id="confirm_pins" placeholder="Verify Pin" class="css-16fg16t" >
                                                                        <label class="bn-input-label css-6lqe90"></label>
                                                                    </div>
                                                                   <div class="css-15nm7oo"></div>
                                                                   <div ><button name="submitpins" type="submit" value=""
                                                                    placeholder="New Pin" > Submit Pin
                                                                    </button>
                                                                </div>
                                    ...
                                    <div class="css-1ma4ge9">
                                        <div class="css-vhzuyw">
                                            <div data-bn-type="text" class="css-etx2pa">Change Login Password</div>
                                            <div class="css-1228rfh">
                                            </div>
                                        </div>
                                        <br/>
                                        <div class="css-1xeouxk"></div>
                                        <form action="" method="post">
                                                                  
                                            <div class="row" >
                                                
                                                <div class="bn-input-md css-1ej5pym"><input data-bn-type="input" value=""
                                       name="password"      id="password" placeholder="New Password" class="css-16fg16t">
                                                    <label class="bn-input-label css-6lqe90"><b></b></label>
                                                </div>
                                               <div class="css-15nm7oo"></div>
                                               <div class="bn-input-md css-1ej5pym"><input data-bn-type="input" value=""
                                         id="confirm_password"       placeholder="Verify Password" class="css-16fg16t">
                                                <label class="bn-input-label css-6lqe90"><b></b></label>
                                            </div>
                                           <div class="css-15nm7oo"></div>
                                           <div ><button name="submitpin" type="submit" value=""
                                            placeholder="New Pin" > Submit Password
                                            </button>
                                        </div>
...
var pins = document.getElementById("pins")
  , confirm_pins = document.getElementById("confirm_pins");
function validatePin(){
  if(pins.value != confirm_pins.value) {
    confirm_pins.setCustomValidity("Pin Don't Match");
  } else {
    confirm_pins.setCustomValidity('');
  }
}
pins.onchange = validatePin;
confirm_pins.onkeyup = validatePin;
