        ...
        <div class="row">
            ...
            <div class="col-md-3 ">
                ...
                <div class="row" style="background: rgb(20, 21, 26) !important; font-size: 8px;">
                    ...
                    <div class="col-md-3" >
                        <button type="button" style="font-size: 10px;"  onclick="window.location.href='ETH_USDT.php'" class="btn btn-outline-dark">ETH/USDT</button>
                    </div>
                    <div class="col-md-3" >
                        <button type="button"style="font-size: 10px;" onclick="window.location.href='XRP_USDT.php'" class="btn btn-outline-dark"  >XRP/USDT</button>
                    </div>
                    <div class="col-md-3" >
                        <button type="button" style="font-size: 10px;" onclick="window.location.href='TRX_USDT.php'" class="btn btn-outline-dark"  >TRX/USDT</button>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <form action=""  method="post" autocomplete="off">
                                            ...
                                            <div class="css-1oy6ugm">
                                                ...
                                                id="orderformBuyBtn" class=" css-k0oot2">Buy ETH</button>
                                        </form>
                                    </div>
                                    <div class="col-md-6">
                                        SELL ETH
                                        <form action="" method="post"  autocomplete="off">
                                            ...
                                            <div class="css-1oy6ugm">
                                                ...
                                                data-sensors-click="true" id="orderformBuyBtn" class=" css-k0oot2">SELL ETH</button>
                                        </form>
                                    </div>
                                </div>
...
height: 350px;"></div>
   ...
   function curP() {
        ...
        function orderBook() {
            ...
            ourRequest.open('GET', 'https://api.binance.com/api/v1/depth?symbol=ETHUSDT&limit=15', true);
