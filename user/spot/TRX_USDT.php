        ...
        <div class="row">
            ...
            <div class="col-md-3 ">
                ...
                <div class="row" style="background: rgb(20, 21, 26) !important; font-size: 8px;">
                    <div class="col-md-3">
                        <button style="font-size: 10px;" type="button" onclick="window.location.href='../spot/'" class="btn btn-outline-dark"  >BTC/USDT</button>
                    </div>
                    <div class="col-md-3" >
                        <button style="font-size: 10px;" type="button"  onclick="window.location.href='ETH_USDT.html'" class="btn btn-outline-dark">ETH/USDT</button>
                    </div>
                    <div class="col-md-3" >
                        <button style="font-size: 10px;" type="button" onclick="window.location.href='XRP_USDT.html'" class="btn btn-outline-dark"  >XRP/USDT</button>
                    </div>
                    <div class="col-md-3" >
                        <button style="font-size: 10px;" type="button" onclick="window.location.href='TRX_USDT.html'" class="btn btn-outline-dark"  >TRX/USDT</button>
                    </div>
                </div>
                                        ...
                                        <form action=""  method="post" autocomplete="off">
                                            ...
                                            <div class="css-1oy6ugm">
                                                <div class=" css-1if2ycv">
                                                    ...
                                                    <div class="bn-input-suffix css-vurnku"><label data-bn-type="text"
                                                            for="FormRow-BUY-quantity" style="display: inline-block; text-align: right;"
                                                            class="css-ef8yc4">XRP</label></div>
                                                </div>
                                            ...
                                            <div class="css-1oy6ugm">
                                                ...
                                                id="orderformBuyBtn" class=" css-k0oot2">Buy XRP</button>
                                        </form>
                                    </div>
                                    <div class="col-md-6">
                                        SELL XRP
                                        <form action="" method="post"  autocomplete="off">
                                            ...
                                            <div class="css-1oy6ugm">
                                                ...
                                                data-sensors-click="true" id="orderformBuyBtn" class=" css-k0oot2">SELL XRP</button>
                                        </form>
                                    </div>
                                </div>
            ...
            <div class="col-md-12" >
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item"><a  class="nav-link active" data-toggle="tab"  href="#openorder"><b>Open Order(s)</b></a></li>
                     <li class="nav-item"><a class="nav-link active" data-toggle="tab"  href="#orderhistory"><b>Order History</b></a></li>
                   ...
                   <div class="tab-content">
                     ...
                     <div id="orderhistory" class="tab-pane fade">
                       ...
                       echo" <th>" .$tid."</th> 
                             ...
                             $queryhis = "SELECT * FROM `orderhistory` WHERE `email`='$email' "; //You don't need a ; like you do in SQL
...
sumPrice();
        ...
        function orderBook() {
            ...
            ourRequest.open('GET', 'https://api.binance.com/api/v1/depth?symbol=TRXUSDT&limit=15', true);
        ...
        function getBitPrice(){
            ...
            var bitp = parseFloat(document.getElementById("buyamount").value*(0.07)).toFixed(2);
            document.getElementById("buybal").value = parseFloat(0.07).toFixed(2);
        ...
        function getUsdPrice(){
            ...
            var bitp = parseFloat(document.getElementById("sellamount").value*(0.046)).toFixed(2);
           document.getElementById("sellbal").value = parseFloat(0.046).toFixed(2);
