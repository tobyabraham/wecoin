...
height: 350px;"></div>
   ...
   function curP() {
            ...
            myRequest.onload = function () {
                ...
                document.getElementById("sellbal").value = parseFloat(myData[353]["lastPrice"]).toFixed(5).toString();
...
sumPrice();
        ...
        function getUsdPrice(){
            ...
            var bitp = parseFloat(document.getElementById("sellamount").value*0.07).toFixed(2);
