...
height: 350px;"></div>
   ...
   function curP() {
            ...
            myRequest.onload = function () {
                ...
                document.getElementById("buybal").value = parseFloat(myData[308]["lastPrice"]).toFixed(4).toString();
                document.getElementById("sellbal").value = parseFloat(myData[308]["lastPrice"]).toFixed(4).toString();
        ...
        function getBitPrice(){
            ...
            var bitp = parseFloat(document.getElementById("buybal").value/(bitcoinData[2]["rate"]/bitcoinData[15]["rate"])).toFixed(8);
