                                            ...
                                            <div class="css-1oy6ugm">
                                                <div class=" css-1if2ycv">
                                                    <div class="bn-input-prefix css-vurnku"><label data-bn-type="text"
                                                      ...
                                                      oninput="getBitPrice()" required="required" min="0.01" step="0.01"  value="" lang="en" >
    ...
    <script>
       ...
       //orderbook.append(messageObj.p);
        ...
        function orderBook() {
            ...
            ourRequest.open('GET', 'https://api.binance.com/api/v1/depth?symbol=XRPUSDT&limit=15', true);
        ...
        function getBitPrice(){
            ...
            var bitp = parseFloat(document.getElementById("buyamount").value*(bitcoinData[2]["rate"]/bitcoinData[15]["rate"])).toFixed(2);
            document.getElementById("buybal").value = parseFloat(bitcoinData[2]["rate"]/bitcoinData[15]["rate"]).toFixed(2);
        ...
        function getUsdPrice(){
            ...
            var bitp = parseFloat(document.getElementById("sellamount").value*(bitcoinData[2]["rate"]/bitcoinData[15]["rate"])).toFixed(2);
           document.getElementById("sellbal").value = parseFloat(bitcoinData[2]["rate"]/bitcoinData[15]["rate"]).toFixed(2);
