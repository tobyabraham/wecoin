...
if(isset($_SESSION["user"])){  
    ...
    $fname = $fname[0];
    $dollar=1 / $btc;
    $btcval = round( $dollar * $row['margin balance'] ,8 );
    $btcdemo = round( $dollar * $row['demo margin'] ,8 );
    $_SESSION['lastlogin'] = $row['last login'];

    if(isset($_POST["tmain"])){
        if($_POST["maininput"] > $_SESSION["marginbalance"]){
            echo '<script >alert("Insufficient Balance")</script>';
        }
        if($_POST["maininput"] < $_SESSION["marginbalance"]){
            $_SESSION["marginbalance"] = ($_SESSION["marginbalance"] - $_POST["maininput"]);
            $updatemarginbal = ($_SESSION["marginbalance"]);
            $main = $_POST["maininput"];
            $query = "UPDATE `users` SET `margin balance`= '$updatemarginbal', `main balance`=`main balance` + '$main' WHERE `email`='$email'";
    ...
    if(isset($_POST["tspotmain"])){
        ...
        if($_POST["maininput"] < $_SESSION["marginbalance"]){
            ...
            $updatemarginbal = ($_SESSION["marginbalance"]);
            $main = $_POST["maininput"];
            $query = "UPDATE `users` SET `margin balance`= '$updatemarginbal', `spot balance`=`spot balance` + '$main' WHERE `email`='$email'";
            mysqli_query($conn,$query) or die("Could Not Perform the Query");
        }
    }
    if(isset($_POST["tdemo"])){
        if($_POST["demoinput"] > $_SESSION["demomargin"]){
            echo '<script >alert("Insufficient Balance")</script>';
        }
        if($_POST["demoinput"] < $_SESSION["demomargin"]){
            $_SESSION["demomargin"] = ($_SESSION["demomargin"] - $_POST["demoinput"]);
            $updatedemobal = ($_SESSION["demomargin"]);
            $demo = $_POST["demoinput"];
            $query = "UPDATE `users` SET `demo margin`= '$updatedemobal', `demo balance`=`demo balance` + '$demo' WHERE `email`='$email'";
            mysqli_query($conn,$query) or die("Could Not Perform the Query");
        }
    }
    if(isset($_POST["tspotdemo"])){
        ...
        if($_POST["demoinput"] < $_SESSION["demomargin"]){
            ...
            $updatedemobal = ($_SESSION["demomargin"]);
            $demo = $_POST["demoinput"];
            $query = "UPDATE `users` SET `demo margin`= '$updatedemobal', `demo spot`=`demo spot` + '$demo' WHERE `email`='$email'";
            mysqli_query($conn,$query) or die("Could Not Perform the Query");
        }
    }
  ?>  
                                            ...
                                            <div class="css-5x6ly7">
                                                ...
                                                <div class="css-10nf7hq">
                                                    <div class="css-4cffwv">
                                                        <div class="css-noqr05"><button data-bn-type="button"
                                                                id="click_dashboard_balance_details_deposit"
                                                                class=" css-d732j0">Deposit</button><button
                                                                data-bn-type="button"
                                                                id="click_dashboard_balance_details_withdraw"
                                                                class=" css-1dfql01">Withdraw</button></div>
                                        ...
                                        <div class="css-vurnku">
                                            <div class="css-4sk89q">
                                                ...
                                                <a href="/user/wallet/margin">   <div id="tab-margin" class="css-yv6506">
                                                    <div class="active css-d3ui9e">Margin</div>
                                                </div></a>
                                                                    ...
                                                                    <div class="css-n5mzgu">
                                                                        <div dir="ltr" class="css-off8uh">
                                                                            <div data-bn-type="text"
                                                                                class="css-1t9tl2o"><span>$</span><?=$_SESSION['marginbalance']?><span style="font-size:12px;">&emsp;<?php echo $btcval; echo 'BTC';?></span>&emsp;&emsp;&emsp;&emsp;&emsp;</div>

                                                                                <div data-bn-type="text"
                                                                                class="css-1t9tl2o" style="text-align:right !important;"><span>$</span><?=$_SESSION['demomargin']?><span style="font-size:12px;">&emsp;<?php echo $btcdemo; echo 'BTC';?></span></div>
...
<br/>
                                                                    ...
                                                                    <div class="css-n5mzgu">
                                                                        <div dir="ltr" class="css-off8uh">
                                                                            <div data-bn-type="text"
                                                                                class="css-1t9tl2o" style="font-size:11px; !important;"><button type="submit" name="tspotmain"><b> Transfer to Spot</b></button>&nbsp;&nbsp;&emsp; &emsp;&emsp;&emsp;</div>
...
<br/>
                                                                    ...
                                                                    <div class="css-n5mzgu">
                                                                        <div dir="ltr" class="css-off8uh">
                                                                            <div data-bn-type="text"
                                                                                class="css-1t9tl2o" style="font-size:11px; !important;"><button type="submit" name="tspotdemo"> <b>Transfer to spot</b></button>&nbsp;&nbsp;&emsp; &emsp;&emsp;&emsp;</div>
